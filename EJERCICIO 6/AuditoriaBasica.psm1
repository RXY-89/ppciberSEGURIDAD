...
.DESCRIPTION
Esta funci´n busca cuentas locales hailitadas que no tienen fecha de último inicio de sesión.
.EXAMPLE
Obtener-UsuariosInactivos
.NOTES
Puede audar a detectar cuentas innecesarias o riesgosas en auditorías básicas.
#>
...
<#
.SYNOPSIS 
Obtiene servicio en ejecución que no pertenecen explícitamente a Windows.
